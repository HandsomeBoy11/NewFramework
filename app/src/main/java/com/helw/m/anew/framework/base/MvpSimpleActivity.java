...
public abstract class MvpSimpleActivity<V extends MvpView, P extends MvpRxSimplePresenter<V>> extends MvpActivity<V, P> implements MvpView {
...
//        NetChangeManager.newInstance(softApplication).removeMinitor(this);
    ...
    public void showProgressDialog() {
        ...
        progressDialog = new CustomerDialog(MvpSimpleActivity.this, R.style.dialog_style);
