package com.helw.m.anew.ui.tab1.weight;
...
//        mTextSize = context.getResources().getDimensionPixelSize(typedValue.resourceId);
        mTextSize = (int) context.getResources().getDimension(R.dimen.cpIndexBarTextSize);
...
//        mTextColor = context.getResources().getColor(typedValue.resourceId);
        ...
        mTextTouchedColor = context.getResources().getColor(R.color.white_light);
    ...
    public void setChar(List<String> list){
        mIndexItems.clear();
